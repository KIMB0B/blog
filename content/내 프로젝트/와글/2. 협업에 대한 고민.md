...
## 3. Issue번호명으로 브랜치 생성
작성한 Issue에서 아래와 같이 브랜치를 바로 만들 수 있도록 하는 기능이 있었습니다.<br>![[Pasted image 20250212020503.png]]

이 기능을 사용하여 Fork한 Repository에 해당 이슈에서 계획한 작업을 할 브랜치를 만들었습니다.<br>이슈 번호가 예를 들어 4번이면 issue4라는 브랜치명을 지었습니다.
![[Pasted image 20250212020607.png]]
...
## 2. Review 진행
다른 팀원들은 방금 올라온 Pull Request의 작업 내용을 확인하고 아래와 같이 approve 혹은 수정해야 할 내용을 적고 reject합니다.<br>![[Pasted image 20250212020719.png]]
...
먼저 프로젝트 가장 Root 경로에 .github란 폴더를 만들고, 아래와 같이 Markdown 파일들을 만들어줬습니다.<br>![[Pasted image 20250212020744.png]]
...
## 1. Discord에서 웹후크 만들기
서버를 우클릭하여 `서버 설정 -> 연동 -> 웹후크`에 들어가서 새 웹후크를 만듭니다.
![[Pasted image 20250212020801.png]]

웹후크 프로필과 활동할 채널을 설정하고 `웹후크 URL 복사`를 클릭합니다.
![[Pasted image 20250212020811.png]]
...
## 3. 알림 온 예시
![[Pasted image 20250212020825.png]]
