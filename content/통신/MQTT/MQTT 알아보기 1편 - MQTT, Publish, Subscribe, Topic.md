...
하지만 아직 이론에 대해 설명하지 못한 내용들이 더 있다. 특히 Broker에 대해서는 다룰 내용이 많아 [[MQTT 알아보기 2편 - QOS, Broker|다음 글]]에 마저 작성하도록 하겠다. 그 후엔 Python을 통해 MQTT를 사용해 보도록 하겠다. 언제든 댓글로 궁금한 점이 있으면 바로 답장해 주도록 하겠다.