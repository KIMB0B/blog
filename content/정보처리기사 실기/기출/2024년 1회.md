...
![[Pasted image 20250623213723.png]]
...
![[Pasted image 20250623213901.png]]
...
![[Pasted image 20250623214022.png]]
...
int main(){
  ...
  for(i=0; p\[i\]!='\0'; i++){
    ...
    else if(!(isupper(p\[i\]) || islower(p\[i\]) || isdigit(p\[i\]))) result\[i\] = p\[i\];
  }
  result\[i\] = '\0';
  printf("%s\n",result);
  return 0;
