...
![[Pasted image 20250623224956.png]]
...
**문제:**
키보드나 마우스와 같은 장치 없이 말이나 행동 그리고 감정과 같은 인간의 자연스러운 표현으로 컴퓨터나 장치를 제어할 수 있는 환경의 영어 약자를 작성하시오.
...
**문제:**
자바 프로그래밍 언어를 이용한 xUnit의 테스트 기법으로써 숨겨진 단위 테스트를 끌어내어 정형화시켜 단위 테스트를 쉽게 해주는 테스트용 Framework의 이름을 작성하시오.
...
![[Pasted image 20250623225309.png]]
